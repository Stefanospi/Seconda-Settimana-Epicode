...
for(y = 0; y<starWarsCharacters.length; y++) {
  if(starWarsCharacters[y].gender === 'female'){
  femaleCharacters.push(starWarsCharacters[y]);
...
for(let i=0; i<charactersNames.length;i++){
  if(charactersNames[i]===femaleCharacters){
    charactersNames.splice(i,1);//rimuoviamo il personaggio dall'array
    i--;
  }
}
*/
